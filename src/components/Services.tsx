...
const services = [
 {
  ...
  skills: ['Executive Support', 'Strategic Planning', 'Operations', 'Project Management', 'Client Management', 'Scheduling', 'Reporting'],
...
},
  {
    ...
    skills: ['Short Form Videos', 'YouTube Editing', 'Reels & TikTok', 'Promotional Videos', 'Color Grading', 'Cinematic Editing'],
  ...
  },
  {
    ...
    skills: ['Content Strategy', 'Content Calendar', 'Social Media Growth', 'Community Management', 'Performance Tracking'],
  ...
  },
  {
    ...
    skills: ['Manual Testing', 'Functional Testing', 'Bug Tracking', 'Quality Reporting', 'Game Testing'],
